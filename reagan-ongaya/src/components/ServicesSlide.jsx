...
export default function ServicesSlide() {
  return (
    <div className="w-full h-full flex items-start justify-center px-6 sm:px-8 md:px-12 lg:px-16 xl:px-24 py-10 md:py-0 overflow-y-auto scrollbar-thin relative noise-overlay">
